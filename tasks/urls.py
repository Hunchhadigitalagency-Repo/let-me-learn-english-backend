...
from tasks.viewsets.listening_part_views import ListeningActivityPartViewSet
...
router.register(r'listening-activity-parts', ListeningActivityPartViewSet, basename='listening-activity-parts')
